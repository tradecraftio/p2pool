...
class WorkerBridge(worker_interface.WorkerBridge):
    ...
    def get_work(self, pubkey_hash, desired_share_target, desired_pseudoshare_target, worker_ip=None):
        ...
        unknown_rules = set(r[1:] if r.startswith('!') else r for r in self.node.bitcoind_work.value['rules']) - set(getattr(self.node.net, 'SOFTFORKS_REQUIRED', [])) - set(['testdummy'])
        if unknown_rules:
        ...
        if True:
            ...
            share_info, gentx, other_transaction_hashes, get_share = share_type.generate_transaction(
                ...
                share_data=dict(
                    ...
                    blockfinal=self.current_work.value['blockfinal'],
